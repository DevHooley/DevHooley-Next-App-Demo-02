...
export default function Home() {
  ...
  return (
    <>
      <section className="bg-gray-100 h-screen flex flex-col items-center  p-4 sm:p-8">
        ...
        <p className="text-gray-800 text-lg sm:text-xl md:text-2xl lg:text-3xl mb-6 text-center">
          This is the main page of our application. Explore the following links
          to navigate to different sections these are all example of different
