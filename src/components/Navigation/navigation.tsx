    ...
    <nav className="bg-gray-100 py-2 flex items-center overflow-x-auto whitespace-nowrap">
      <div className="flex space-x-4 sm:space-x-6 md:space-x-8 lg:space-x-10 xl:space-x-12 pr-6 pl-6 p-2">
        <ul className="flex items-center justify-center space-x-4 sm:space-x-6 md:space-x-8 lg:space-x-10 xl:space-x-12">
          ...
          <li className="flex-shrink-0">
            <Link
              className=" text-2xl sm:text-4xl md:text-5xl lg:text-6xl inline-block w-full px-3 py-2  bg-purple-600 text-white rounded-md shadow-md hover:shadow-lg transform hover:scale-105 transition-transform duration-300 active:bg-purple-600 active:shadow-inner active:scale-100"
              href="/zustand"
            >
              Zustand
            </Link>
